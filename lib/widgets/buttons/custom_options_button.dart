...
/// The default transition builder used by [CustomOptionsButton].
///
/// Wraps [child] in a [ScaleTransition].
Widget defaultCustomOptionsButtonTransitionBuilder(
  Widget child,
...
class CustomOptionsButton extends StatelessWidget {
  ...
  const CustomOptionsButton({
    ...
    this.transitionBuilder = defaultCustomOptionsButtonTransitionBuilder,
  });
  ...
  Widget build(BuildContext context) {
    return IconButton(
      ...
      icon: AnimatedSwitcher(
        ...
        child: KeyedSubtree(
          key: Key('CustomOptionsButton#$isOpen'),
